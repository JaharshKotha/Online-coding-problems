...
if (isset($_POST['submitfile']))
{
   ...
   mysql_query($query) or die("unable to submit the query");
...
{
   $res = mysql_query("select content from files where name = '${_POST['name']}' and password = '${_POST['password']}'") or die(mysql_error());
