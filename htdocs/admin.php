...
<div data-reactid=".2.1.0" class="MetadataEditor-table-list AdminList flex-no-shrink" style="height:35%; background-color:transparent; font-size:1.5rem;
 color:black">
   <ul data-reactid=".2.1.0.0" class="AdminList-items pt1">
	  ...
	  <li data-reactid=".2.1.0.0.$Slack"><a data-reactid=".2.1.0.0.$Slack.0" class="AdminList-item flex align-center no-decoration" href="coloumnRename.php">Table name Mappings</a></li>
   </ul>
</div>
...
while($row = pg_fetch_array($r))
{
	...
	if(trim($row[3])!=trim("Primary Admin"))
	{
