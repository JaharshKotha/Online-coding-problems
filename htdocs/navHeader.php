...
<script>
    $(document).ready(function () {
        if (window.location.href.indexOf("queryPage.php") >= 0)
        {
            var some = $("#NewQuestion").attr("class");
            $("#NewQuestion").attr("class",$("#DashBoard").attr("class"));
              $("#DashBoard").attr("class",some);

        }
        else if(window.location.href.indexOf("dash.php") >= 0)
        {
              //do Nothing
        }
        else
        {
          //  var some = $("#DashBoard").attr("class");
            $("#DashBoard").attr("class",$("#NewQuestion").attr("class"));
            //  $("#NewQuestion").attr("class",some);
            
        }
      	 
$("#tog_name").click(function(){
    $("#tog_section").toggle();
                        $("#tog_section").css("z-index", 100);
...
<style>
    ...
    .border-purple {
        border-color: rgb(72,142,204) !important;
    }
    .border-error {
    ...
    .FilterPopover .ColumnarSelector-row--selected, .FilterPopover .PopoverHeader-item.selected {
        color: rgb(72,142,204) !important;
    }
    .FilterPopover .ColumnarSelector-row:hover {
        background-color: rgb(72,142,204) !important;
    }
    ...
    .FilterRemove-field {
        align-items: center;
        background-color: rgb(72,142,204);
        border: 1px solid rgb(72,142,204);
        border-radius: 99px;
        display: flex;
        height: 20px;
        justify-content: center;
...
table {
	...
	<header data-reactid=".d.0.0" class="DashboardHeader relative z2" >
        <div mb-react-component="Navbar" ng-controller="Nav" class="Nav ng-scope">
            <nav class="CheckBg CheckBg-offset relative bg-brand sm-py2 sm-py1 xl-py3" style=" background-color:#21618C;">
                <ul class="pl4 pr1 flex align-center">
                      <li style="width:200px">
                            <img style="width:90%;height:auto;" align="center" src='img/intellispyre_logo.png'>
                            <?php
                            /*
                    ...
                    <li  class="pl1" style="left:300px;"><a href="dash.php" id="DashBoard" class="DashBoard rounded inline-block bg-white text-brand text-bold cursor-pointer px2 no-decoration transition-all" style="padding-left:1.0rem;padding-right:1.0rem;padding-top:0.75rem;padding-bottom:0.75rem;" data-metabase-event="Navbar;Questions">Dashboard</a>
                    </li>  
                    <li class="pl3"><a href="queryPage.php" id="NewQuestion"  class="NavItem cursor-pointer text-white text-bold no-decoration flex align-center px2 transition-background" style="padding-left:1.0rem;padding-right:1.0rem;padding-top:0.75rem;padding-bottom:0.75rem;" data-metabase-event="Navbar;New Question"><span  >New Question</span></a>
                    </li>
                                ...
                                <a data-reactid=".0.0.5.0.0.0" class="NavDropdown-button NavItem flex align-center p2 transition-background" data-metabase-event="Navbar;Profile Dropdown;Toggle">
                                    <div data-reactid=".0.0.5.0.0.0.0" class="NavDropdown-button-layer" >
                                        <div data-reactid=".0.0.5.0.0.0.0.0" class="flex align-center" >
                                            <div id="tog_name" data-reactid=".0.0.5.0.0.0.0.0.0" style="font-size:0.85rem;border-width:1px;border-style:solid;border-radius:99px;width:2rem;height:2rem;background-color:transparent;" class="flex align-center justify-center bg-brand"><?php echo $_SESSION['displayname']; ?></div>
                                            <svg id="arrowd" data-reactid=".0.0.5.0.0.0.0.0.1" name="chevrondown" fill="currentcolor" viewBox="0 0 32 32" height="8px" width="8px" class="Dropdown-chevron ml1">
...
?>
<li data-reactid=".0.0.5.0.0.1.0.3"><a data-reactid=".0.0.5.0.0.1.0.3.0" target="#" href="helpfiles/help.php" class="Dropdown-item block text-white no-decoration" data-metabase-event="Navbar;Profile Dropdown;Help v0.16.1">Help</a></li>
